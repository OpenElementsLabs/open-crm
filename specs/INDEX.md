...
| 008 | Global UI styling fixes | Add missing shadcn/ui semantic CSS variables for dialog/select backgrounds and table borders | — | open   |
| 009 | Contact-company navigation | Bidirectional navigation links between contact detail and company detail views | — | open   |
